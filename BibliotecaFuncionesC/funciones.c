...
int numeroEnteroObtener(char mensaje[])
{
    int numeroEntero;
    printf("%s",mensaje);
...
int numeroEnteroValidar (int numeroAValidar, int maximo, int minimo)
{
   int validacion; /** 1 para verdadero, 0 para falso*/
   /*

    if(numeroAValidar>maximo || numeroAValidar<minimo)
    {
        validacion=0;
    }else{
        validacion=1;
